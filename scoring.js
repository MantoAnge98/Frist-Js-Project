...
let rankTable = ["A","B","C","D"];
 ...
 // Créer la logique du juge final.
  function judgement(){
    ...
    $('#declaration').append(`<label id="alert-indicate" class="alert alert-info">Quelles sont vos notes ? Votre Classement est: ${achievement} Votre résultat est :${pass_or_failure}</label>`);
  };
